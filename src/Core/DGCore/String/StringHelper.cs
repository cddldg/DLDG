...
namespace DGCore.String
{
    ...
    public static class StringHelper
    {
        ...
        /// <param name="code">16,32(默认)</param>
        /// <returns></returns>
        public static string GetMd5Hash(string input,int code=32)
        {
            ...
            using (MD5 md5Hash = MD5.Create())
            {
                if(code==16)
                {
                    string res = BitConverter.ToString(md5Hash.ComputeHash(UTF8Encoding.Default.GetBytes(input)), 4, 8);
                    res = res.Replace("-", "");
                    retStr= res.ToLower();
                }
                if (code == 32)
                {
                    ...
                    retStr= sBuilder.ToString().ToLower();
                }
            }
            return retStr;
        }
        ...
        public static string safeInt(string str)
        {
            ...
            try
            {
                constr = (System.Convert.ToInt16(str)).ToString();
                return constr;
            }
            catch
            {
        ...
        public static string ClearInputText(string inputString, int maxLength)
        {
            ...
            // 检查是否为空
            if ((inputString != null) && (inputString != System.String.Empty))
            {
