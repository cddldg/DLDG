...
namespace DGCore.ChineseCalendar
{
    /// <summary>
    /// 中国日历
    /// </summary>
    public static class CNCalendarHelper
    {
        ...
        /// </remarks>
        /// <returns></returns>
        public static ChineseCalendarInfo GetChineseCalendar(DateTime dt)
        {
        ...
        /// <returns></returns>
        public static ChineseCalendarInfo GetChineseCalendar(int cy, int cm, int cd, bool leapMonthFlag)
        {
            return new ChineseCalendarInfo(cy, cm, cd, leapMonthFlag);
        }
    }
    /// <summary>
    /// 中国日历
