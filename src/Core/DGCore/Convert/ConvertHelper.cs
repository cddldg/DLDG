...
namespace DGCore.Convert
{
    ...
    public static class ConvertHelper
    {
        ...
        {
            if (int.TryParse(obj.ObjToJsonString(), out int cov))
            {
                return cov;
            }
            return null;
        ...
        {
            if (long.TryParse(obj.ObjToJsonString(), out long cov))
            {
                return cov;
            }
            return null;
        ...
        {
            if (double.TryParse(obj.ObjToJsonString(), out double cov))
            {
                return cov;
            }
            return null;
        ...
        {
            if (decimal.TryParse(obj.ObjToJsonString(), out decimal cov))
            {
                return cov;
            }
            return null;
        ...
        {
            if (float.TryParse(obj.ObjToJsonString(), out float cov))
            {
                return cov;
            }
            return null;
        ...
        {
            if (bool.TryParse(obj.ObjToJsonString(), out bool ret))
            {
                return ret ? 1 : 0; ;
            }
            else
