...
namespace DG.Convert
{
    ...
    public static class ConvertHelper
    {
        ...
        {
            int cov = 0;
            if (int.TryParse(obj.ObjToJsonString(), out cov))
            {
                return cov;
            }
            return null;
        ...
        {
            long cov = 0;
            if (long.TryParse(obj.ObjToJsonString(), out cov))
            {
                return cov;
            }
            return null;
        ...
        {
            double cov = 0;
            if (double.TryParse(obj.ObjToJsonString(), out cov))
            {
                return cov;
            }
            return null;
        ...
        {
            decimal cov = 0;
            if (decimal.TryParse(obj.ObjToJsonString(), out cov))
            {
                return cov;
            }
            return null;
        ...
        {
            float cov = 0;
            if (float.TryParse(obj.ObjToJsonString(), out cov))
            {
                return cov;
            }
            return null;
        ...
        {
            bool ret = false;
            if(bool.TryParse(obj.ObjToJsonString(),out ret))
            {
                return ret ? 1 : 0;;
            }
            else
